local M = {
  ...
  config = function()
    ...
    local set_terminal_keymaps = function()
      buf_map(0, "t", "<esc>", [[<C-\><C-t>]], opts)
      buf_map(0, "t", "<C-h>", [[<C-\><C-t><C-W>h]], opts)
      buf_map(0, "t", "<C-j>", [[<C-\><C-t><C-W>j]], opts)
      buf_map(0, "t", "<C-k>", [[<C-\><C-t><C-W>k]], opts)
      buf_map(0, "t", "<C-l>", [[<C-\><C-t><C-W>l]], opts)
    end
